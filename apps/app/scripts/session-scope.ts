...
const starterRoot = "/Users/test/Rantai/starter";
const otherRoot = "/Users/test/Rantai/second";
...
try {
  ...
  step("windows create and list use the same transport directory", () => {
    ...
    const winRoot = String.raw`C:\Users\Test\Rantai\starter`;
    ...
    const verbatimDriveRoot = String.raw`\\?\C:\Users\Test\Rantai\starter`;
    assert.equal(toSessionTransportDirectory(verbatimDriveRoot), String.raw`C:\Users\Test\Rantai\starter`);
