 ...
 * Termos profissionais (Skills, Plugins, Commands, Sessions, OpenCode, OpenPackage, Rantai) NÃO são traduzidos
 */
...
export default {
  ...
  "app.plugins_hint_readonly": "O servidor Rantai está em modo somente leitura para plugins.",
  "app.reload_later": "Depois",
  "app.reload_now": "Recarregar agora",
  "app.reload_stop_tasks": "Recarregar e Parar Tarefas",
  "app.skills_hint_readonly": "O servidor Rantai está em modo somente leitura para skills. Adicione um token de host em Avançado para habilitar instalações.",
  ...
  "blueprint.welcome_message": "Olá, boas-vindas ao Rantai!\n\nAs pessoas usam o Rantai para escrever arquivos .csv no computador, automatizar tarefas no navegador e sincronizar contatos com o Notion.\n\nMas o único limite é a sua imaginação.\n\nO que você gostaria de fazer?",
  "blueprint.welcome_title": "Boas-vindas ao Rantai",
  ...
  "config.reload_availability_hint": "O recarregamento está disponível apenas para workers locais ou servidores Rantai conectados.",
  ...
  "config.server_needed_hint": "Conexão com o servidor Rantai necessária para sincronizar skills, plugins e comandos.",
  "config.server_section_desc": "Conecte a um servidor Rantai. Use a URL mais um token de colaborador ou proprietário do administrador do servidor.",
  ...
  "config.server_sharing_title": "Compartilhamento do servidor Rantai",
  "config.server_url_hint": "Use a URL compartilhada pelo seu servidor Rantai. Workers locais do desktop reutilizam uma porta alta persistente na faixa 48000-51000.",
  "config.server_url_input_label": "URL do servidor Rantai",
  "config.server_url_label": "URL do Servidor Rantai",
  ...
  "context_panel.authorized_folders_no_access": "Conecte a um workspace Rantai com permissão de escrita para editar as pastas autorizadas.",
  "context_panel.browse_button": "Navegar",
  "context_panel.config_access_unavailable": "O acesso à configuração do servidor Rantai não está disponível para este workspace.",
  "context_panel.config_read_only": "O servidor Rantai está conectado em modo somente leitura para configuração do workspace.",
  ...
  "context_panel.server_disconnected": "Servidor Rantai desconectado.",
  ...
  "context_panel.writable_workspace_required": "É necessário um workspace Rantai com permissão de escrita para atualizar as pastas autorizadas.",
  ...
  "dashboard.chooser_remote_desc": "Conecte a um worker Rantai auto-hospedado usando uma URL e token de acesso.",
  ...
  "dashboard.create_remote_custom_subtitle": "Conecte a um worker Rantai auto-hospedado.",
  ...
  "dashboard.create_remote_workspace_subtitle": "Salvar um servidor Rantai como workspace.",
  ...
  "dashboard.edit_remote_workspace_subtitle": "Atualizar os dados do servidor Rantai para este workspace.",
  ...
  "dashboard.remote_server_details_hint": "Conecte a um worker Rantai auto-hospedado.",
  ...
  "den.auto_reconnect_hint": "Conclua a autenticação no navegador e o Rantai reconectará aqui automaticamente.",
  ...
  "den.cloud_provider_needs_server": "Requer o servidor Rantai",
  ...
  "den.error_paste_valid_code": "Cole um link de login do Rantai válido ou um código de uso único.",
  ...
  "den.signin_link_hint": "Se o navegador não redirecionar de volta para o Rantai automaticamente, cole o link de login ou código de uso único do OpenWork Cloud aqui.",
  ...
  "den.status_browser_signin": "Conclua o login no navegador para conectar o Rantai.",
  "den.status_browser_signup": "Conclua a criação da conta no navegador para conectar o Rantai.",
  ...
  "mcp.apps_subtitle": "Conecte suas ferramentas favoritas para que o Rantai as use em seu nome.",
  "mcp.apps_title": "Apps",
  ...
  "mcp.auth.reload_notice": "Para isso ter efeito, o Rantai precisa reiniciar o serviço worker. Isso pode interromper uma sessão em andamento.",
  "mcp.auth.reload_remote_confirm": "Para isso ter efeito, o Rantai precisa reiniciar o serviço worker. Isso pode parar sua sessão em andamento. Continuar?",
  ...
  "mcp.auth.step2_title": "Autorizar o Rantai",
  ...
  "mcp.login_unavailable": "Este app não suporta login pelo Rantai.",
  ...
  "session.share_local_host_not_ready": "O host local do Rantai ainda não está pronto.",
  "session.share_missing_host_url": "URL do host Rantai ausente.",
  "session.share_missing_token": "Token do Rantai ausente.",
  ...
  "session.share_openwork_workers_only": "Links de compartilhamento estão disponíveis para workers Rantai.",
  ...
  "settings.background_checks_desc": "O Rantai sempre verifica ao iniciar. Também verifica uma vez",
  ...
  "settings.capabilities_title": "Capacidades do servidor Rantai",
  ...
  "settings.custom_binary_hint": "Use para apontar o Rantai para um build local do OpenCode",
  ...
  "settings.docker_containers_desc": "Forçar remoção de containers Docker iniciados pelo Rantai",
  "settings.docker_containers_title": "Containers Docker do Rantai",
  ...
  "settings.enable_exa_desc": "Aplica-se quando o Rantai inicia o OpenCode.",
  ...
  "settings.feedback_title": "Ajude a moldar o Rantai",
  ...
  "settings.open_deeplink_desc": "Cole um deeplink ou URL compartilhada do Rantai para abrir.",
  ...
  "settings.openwork_diagnostics_title": "Diagnósticos do servidor Rantai",
  ...
  "settings.quit_hint": "O Rantai fecha imediatamente após a limpeza para que a próxima inicialização comece de um estado local limpo para este modo.",
  ...
  "settings.reconnect_server_failed": "Falha ao reconectar o servidor Rantai.",
  "settings.reconnected": "Reconectado ao servidor Rantai.",
  ...
  "settings.reset_app_data_description": "Mais agressivo. Apaga cache + dados do Rantai.",
  "settings.reset_app_data_title": "Redefinir dados do app",
  "settings.reset_app_data_warning": "Apaga cache e dados do Rantai neste dispositivo.",
  ...
  "settings.reset_confirmation_hint": "Digite {resetWord} para confirmar. O Rantai será reiniciado.",
  ...
  "settings.reset_onboarding_description": "Apaga as preferências do Rantai e reinicia o app.",
  "settings.reset_onboarding_title": "Redefinir onboarding",
  "settings.reset_onboarding_warning": "Apaga preferências locais e marcadores de onboarding do workspace no Rantai.",
  ...
  "settings.reset_openwork_title": "Redefinir estado do Rantai + OpenCode",
  ...
  "settings.restart_blocked_message": "O Rantai precisa reiniciar para concluir esta atualização. Para não interromper seu trabalho atual, a instalação está pausada até que suas execuções ativas terminem ou sejam paradas.",
  ...
  "settings.runtime_desc": "Status do seu engine local e servidor Rantai.",
  ...
  "settings.tab_description_appearance": "Ajuste a aparência do Rantai no desktop, tema do sistema e decoração do app.",
  ...
  "settings.tab_description_general": "Conecte provedores, escolha o modelo padrão, autorize pastas e controle o workspace Rantai selecionado e sua conexão de runtime.",
  ...
  "settings.updates_desc": "Manter o Rantai atualizado.",
  ...
  "share_skill_destination.connect_remote_hint": "Vincule um host Rantai e selecione-o na lista para importar esta skill.",
  ...
  "skills.host_only_error": "O gerenciamento de skills requer um workspace local ou servidor Rantai conectado.",
  ...
  "status.limited_hint": "Reconecte para restaurar todos os recursos do Rantai",
  ...
  "status.openwork_ready": "Rantai Pronto",
  ...
  "system.reload_body_default": "O Rantai detectou mudanças que exigem recarregar a instância do OpenCode.",
  "system.reload_body_mcp": "O OpenCode carrega servidores MCP na inicialização. Recarregue o engine para ativar a nova conexão.",
  "system.reload_body_mixed": "O Rantai detectou mudanças na configuração do OpenCode. Recarregue o engine para aplicá-las.",
  ...
  "workspace_list.remote_worker_unavailable_hint": "O Rantai não consegue carregar tarefas deste worker até que a conexão seja corrigida.",
