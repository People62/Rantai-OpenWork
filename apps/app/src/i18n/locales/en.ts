 ...
 * Professional terms (Skills, Plugins, Commands, Sessions, OpenCode, OpenPackage, Rantai) are NOT translated
 */
...
export default {
  ...
  "app.plugins_hint_readonly": "Rantai server is read-only for plugins.",
  "app.reload_later": "Later",
  "app.reload_now": "Reload now",
  "app.reload_stop_tasks": "Reload & Stop Tasks",
  "app.skills_hint_readonly": "Rantai server is read-only for skills. Add a host token in Advanced to enable installs.",
  ...
  "connect.diagnostics_agent_description": "Redacted evidence from the server-computed Rantai agent configuration intent. Effective engine state was not observed.",
  "connect.diagnostics_agent_description_effective": "Redacted evidence from the effective engine-resolved Rantai agent and its context markers.",
  ...
  "connect.diagnostics_check_agent_resolution": "Rantai agent configuration intent",
  "connect.diagnostics_check_agent_resolution_effective": "Effective Rantai agent resolution",
  ...
  "connect.diagnostics_mcp_description_effective": "The engine's merged configuration and Rantai-managed dynamic injection intent are shown separately. Runtime rows include exact registration outcomes; this is not a complete live tool-registry snapshot.",
  ...
  "connect.diagnostics_owner_openwork_client": "Rantai client",
  "connect.diagnostics_owner_openwork_server": "Rantai server",
  "connect.diagnostics_owner_openwork_support": "Rantai support",
  ...
  "connect.diagnostics_configured_agent": "Configured Rantai agent",
  "connect.diagnostics_effective_agent": "Effective Rantai agent",
  "connect.diagnostics_agent_state": "Rantai agent state",
  ...
  "connect.diagnostics_unavailable_direct_opencode": "For privacy, agent diagnostics are unavailable for direct remote OpenCode workspaces. Use a remote Rantai workspace to run this report.",
  ...
  "connect.pitch_title": "Connect is the new way Rantai lets you share workflows with your team.",
  ...
  "connect.state_unavailable_action": "Restart Rantai. If this continues, run diagnostics.",
  ...
  "config.reload_availability_hint": "Reloading is only available for local workers or connected Rantai servers.",
  ...
  "config.server_needed_hint": "Rantai server connection needed to sync skills, plugins, and commands.",
  "config.server_section_desc": "Connect to a Rantai server. Use the URL plus a collaborator or owner token from your server admin.",
  "config.server_section_title": "Rantai server",
  ...
  "config.server_sharing_title": "Rantai server sharing",
  "config.server_url_hint": "Use the URL shared by your Rantai server. Local desktop workers reuse a persistent high port in the 48000-51000 range.",
  "config.server_url_input_label": "Rantai server URL",
  "config.server_url_label": "Rantai Server URL",
  ...
  "context_panel.authorized_folders_no_access": "Connect to a writable Rantai server workspace to edit authorized folders.",
  "context_panel.browse_button": "Browse",
  "context_panel.config_access_unavailable": "Rantai server config access is unavailable for this workspace.",
  "context_panel.config_read_only": "Rantai server is connected read-only for workspace config.",
  ...
  "context_panel.server_disconnected": "Rantai server is disconnected.",
  ...
  "context_panel.writable_workspace_required": "A writable Rantai server workspace is required to update authorized folders.",
  ...
  "dashboard.chooser_remote_desc": "Attach to a self-hosted Rantai worker using a URL and access token.",
  ...
  "dashboard.create_remote_custom_subtitle": "Attach to a self-hosted Rantai worker.",
  "dashboard.create_remote_custom_title": "Connect custom remote",
  "dashboard.create_remote_workspace_confirm": "Add Workspace",
  "dashboard.create_remote_workspace_subtitle": "Save a Rantai server as a workspace.",
  ...
  "dashboard.edit_remote_workspace_subtitle": "Update the Rantai server details for this workspace.",
  ...
  "dashboard.remote_server_details_hint": "Attach to a self-hosted Rantai worker.",
  ...
  "connect.error_unknown_kid": "This link was signed with a newer key than this app knows. Update Rantai and try again.",
  ...
  "den.auto_reconnect_hint": "Finish auth in your browser and Rantai will reconnect here automatically.",
  ...
  "den.cloud_provider_needs_server": "Needs Rantai server",
  ...
  "den.error_paste_valid_code": "Paste a valid Rantai sign-in link or one-time sign-in code.",
  ...
  "den.signin_link_hint": "If your browser doesn't bounce back into Rantai automatically, paste the sign-in link or one-time code from OpenWork Cloud here.",
  ...
  "den.status_browser_signin": "Finish signing in in your browser to connect Rantai.",
  "den.status_browser_signin_paste": "Sign in in your browser, copy the Rantai link, then paste it below.",
  "den.status_browser_signup": "Finish account creation in your browser to connect Rantai.",
  "den.status_browser_signup_paste": "Create your account in the browser, copy the Rantai link, then paste it below.",
  ...
  "den.status_server_config_cleared": "Cleared the desktop server configuration. Rantai is using the default Cloud control plane.",
  ...
  "extensions.add_plugin_collection_hint": "Publishing puts the plugin in the collection so members find it in the Rantai app.",
  ...
  "extensions.marketplace_description": "Browse Rantai built-ins and organization marketplace extensions. Built-ins stay local; organization marketplace extensions run through OpenWork Cloud, while GitHub and Claude plugin imports live in local Library.",
  ...
  "mcp.toggle_requires_server": "Connect to a Rantai server to enable or disable MCPs.",
  ...
  "mcp.apps_subtitle": "Connect your favorite tools so Rantai can use them on your behalf.",
  "mcp.apps_title": "Apps",
  ...
  "mcp.auth.reload_notice": "For this to take effect, Rantai needs to refresh the worker service. This can interrupt a running session.",
  "mcp.auth.reload_remote_confirm": "For this to take effect, Rantai needs to refresh the worker service. This might stop your running session. Continue?",
  ...
  "mcp.auth.step2_title": "Authorize Rantai",
  ...
  "mcp.login_unavailable": "This app does not support sign-in from Rantai.",
  ...
  "mcp.managed_oauth_unavailable": "Secure storage is unavailable on this device, so Rantai-managed sign-ins are paused.",
  ...
  "mcp.oauth_secret_warning": "Rantai encrypts these credentials in local app data. They are not written to your workspace or OpenCode configuration. Keep client secrets out of chats and source control.",
  ...
  "mcp.quick_connect_openwork_ui_desc": "Let agents see and drive the Rantai app. Navigate sessions, type into the composer, open settings. Try: \"Take a snapshot of what I see\" or \"Create a new session and type hello.\"",
  "mcp.quick_connect_openwork_ui_title": "Rantai UI Control",
  ...
  "notifications.reconnect_failed": "Couldn't reconnect to the Rantai server",
  ...
  "welcome.title": "Welcome to Rantai",
  ...
  "welcome.organization_server_dialog_desc": "Paste the server URL your IT team shared. Rantai will use it before sign-in and cloud features.",
  "welcome.organization_server_dialog_title": "Connect to your organization's server",
  "welcome.organization_server_error": "Enter a valid http:// or https:// Rantai server URL.",
  "welcome.organization_server_link": "Using Rantai on-premises?",
  ...
  "welcome.use_cloud_subtitle": "Sign in for hosted Rantai and team features",
  ...
  "welcome.folder_explanation": "This folder becomes your workspace. Rantai will be able to:",
  ...
  "welcome.folder_drop_hint": "Drop files in anytime and Rantai can pick them up.",
  ...
  "join_org.confirm_invite_body": "Only continue if you trust {host}. Rantai will use it as your organization server and open the invite in your browser.",
  ...
  "join_org.error_invalid": "That does not look like a Rantai invite link, install link, server URL, or sign-in code.",
  "join_org.error_invalid_config": "This link opened, but it did not contain a valid Rantai organization setup. Ask your admin for a fresh one.",
  "join_org.error_network": "Rantai could not reach that organization server. Check your connection or VPN, then try again.",
  ...
  "join_org.invite_opened": "Your invite opened in the browser — finish joining there. Rantai now points at {host} and is ready when you come back.",
  ...
  "session.share_local_host_not_ready": "Local Rantai host is not ready yet.",
  "session.share_missing_host_url": "Missing Rantai host URL.",
  "session.share_missing_token": "Missing Rantai token.",
  ...
  "session.share_openwork_workers_only": "Share service links are available for Rantai workers.",
  ...
  "settings.privacy_section_desc": "Control what Rantai shares to improve the product.",
  ...
  "settings.capabilities_title": "Rantai server capabilities",
  ...
  "settings.custom_binary_hint": "Use this to point Rantai at a local OpenCode build",
  ...
  "settings.debug_openwork_server_version": "Rantai server: {version}",
  ...
  "settings.runtime_config_one_writer_rule": "Rantai writes only the managed runtime config file; user OpenCode config stays user-owned.",
  ...
  "settings.runtime_config_no_removed_keys": "No Rantai-managed keys removed.",
  ...
  "settings.desktop_notifications.mode_desc": "Choose which Rantai events can appear as native operating system notifications.",
  ...
  "settings.enable_exa_desc": "Applies the next time OpenCode is started by Rantai. Off by default.",
  ...
  "settings.feedback_title": "Help shape Rantai",
  ...
  "settings.nuke_confirmation_hint": "Rantai will revoke your cloud session best-effort, wipe local state, then relaunch.",
  ...
  "settings.nuke_dialog_desc": "This removes local Rantai, OpenCode, browser, token, runtime, cache, and legacy runtime state on this device.",
  ...
  "settings.nuke_survives_app": "The installed Rantai app and protocol registration stay installed.",
  "settings.nuke_survives_bootstrap": "Bootstrap / organization server: {path}",
  "settings.nuke_survives_title": "Will survive",
  "settings.nuke_survives_workspaces": "Workspace folders and your files inside them are not touched, but each workspace's Rantai state (.opencode/openwork) is removed.",
  "settings.off": "Off",
  "settings.on": "On",
  "settings.open_deeplink_action": "Opening...",
  "settings.open_deeplink_button": "Hide",
  "settings.open_deeplink_desc": "Paste a Rantai deeplink or share URL to open it.",
  ...
  "settings.organization_server_desc": "Point Rantai at the server your organization hosts. This is available without developer mode.",
  "settings.organization_server_title": "Organization server",
  "settings.organization_server_url_hint": "Paste your organization's Rantai server URL. Saving signs you out so Rantai can re-hydrate against that server.",
  ...
  "settings.opencode_engine_sidecar_desc": "Local OpenCode process managed by Rantai.",
  ...
  "settings.openwork_config_sidecar_desc": "Local Rantai server (Bun) that hosts approvals, audit, and OpenCode lifecycle.",
  "settings.openwork_diagnostics_title": "Rantai server diagnostics",
  "settings.openwork_server_desc": "Session control plane for app sync, workers, and remote",
  "settings.openwork_server_label": "Rantai server",
  ...
  "settings.quit_hint": "Rantai quits immediately after cleanup so the next launch starts from a blank local state for this mode.",
  ...
  "settings.reconnect_server_failed": "Failed to reconnect Rantai server.",
  "settings.reconnected": "Reconnected to Rantai server.",
  ...
  "settings.reset_app_data_description": "More aggressive. Clears Rantai cache + app data.",
  "settings.reset_app_data_title": "Reset app data",
  "settings.reset_app_data_warning": "Clears Rantai cache and app data on this device.",
  ...
  "settings.reset_confirmation_hint": "Type {resetWord} to confirm. Rantai will restart.",
  ...
  "settings.reset_onboarding_description": "Clears Rantai preferences and restarts the app.",
  "settings.reset_onboarding_title": "Reset onboarding",
  "settings.reset_onboarding_warning": "Clears Rantai local preferences and workspace onboarding markers.",
  ...
  "settings.reset_openwork_title": "Reset Rantai + OpenCode state",
  ...
  "settings.restart_blocked_message": "The update is ready, but Rantai will wait until your active tasks finish before restarting. You can also stop them manually.",
  "settings.restart_failed": "Restart failed. Check logs and try again.",
  "settings.restart_opencode": "Restart OpenCode",
  "settings.restart_openwork_server": "Restart Rantai server",
  ...
  "settings.services_section_desc": "Local services that power this Rantai session. Each service has its own restart and logs.",
  ...
  "settings.recovery_section_desc": "Roll back state without quitting Rantai.",
  ...
  "settings.server_endpoints_desc": "Read-only view of the URLs Rantai will use after local overrides and bootstrap files are applied.",
  ...
  "settings.runtime_desc": "Status for your local engine and Rantai server.",
  ...
  "settings.tab_description_appearance": "Adjust how Rantai looks across desktop, system theme, and app frame.",
  ...
  "settings.tab_description_general": "Connect providers, choose the default model, authorize folders, and control the selected Rantai workspace plus its runtime connection.",
  ...
  "settings.environment.override_hint": "Environment variables set before Rantai starts take precedence over values saved here.",
  ...
  "settings.environment.apply_confirm_body": "Rantai will restart local agents so they can use the latest environment. Running local tasks may stop.",
  "settings.environment.apply_no_local_workspace": "Rantai is not connected to a local workspace.",
  ...
  "settings.environment.apply_refresh_failed": "Changes are active, but Rantai status did not refresh. Reopen the app if it looks stale.",
  ...
  "settings.environment.validation_reserved": "OPENWORK_ and OPENCODE_ names are managed by Rantai/OpenCode.",
  ...
  "memory.sign_in_hint": "Sign in to your Rantai account to view your memory bank.",
  ...
  "settings.update_blocked_org": "Rantai {version} is available, but your organization has not approved it yet. Ask an organization administrator to enable this version.",
  ...
  "settings.update_restart_active_tasks": "You have active tasks. Installing the update restarts Rantai and will interrupt them.",
  "settings.update_restart_confirm_title": "Restart with active tasks?",
  "settings.update_restart_confirm_message": "Installing the update restarts Rantai now and interrupts your active tasks. You may need to resume them after the update.",
  "settings.update_uptodate": "You're up to date",
  "settings.updates": "Updates",
  "settings.updates_desc": "Keep Rantai up to date.",
  ...
  "share_skill_destination.connect_remote_hint": "Attach a Rantai host, then choose it from the list to import this skill.",
  ...
  "skills.host_only_error": "Skill management requires a local workspace or connected Rantai server.",
  ...
  "status.limited_hint": "Reconnect to restore full Rantai features",
  ...
  "status.openwork_ready": "Rantai Ready",
  ...
  "system.reload_body_default": "Rantai detected changes that require reloading the OpenCode instance.",
  "system.reload_body_mcp": "OpenCode loads MCP servers at startup. Reload the engine to activate the new connection.",
  "system.reload_body_mixed": "Rantai detected OpenCode configuration changes. Reload the engine to apply them.",
  ...
  "workspace_list.remote_worker_unavailable_hint": "Rantai can't load tasks from this worker until the connection is fixed.",
