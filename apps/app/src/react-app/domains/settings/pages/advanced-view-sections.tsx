        ...
        {props.cloudMcpHealth ? (
          <div className="space-y-2 rounded-xl border border-gray-6 bg-gray-1/60 p-3">
            <div className="grid gap-2">
              ...
              {compatibility ? (
                <>
                  <DiagnosticRow label="Rantai versions" value={`server ${formatMaybe(compatibility.openwork.serverVersion)}; app ${formatMetadataRecord(compatibility.openwork.app)}`} />
  ...
  return (
    <LayoutSection>
      <LayoutSectionHeader>
        ...
        <LayoutSectionDescription>
          Inspect what Rantai controls at runtime versus what belongs to your workspace config. This works through the Rantai server and does not require the OpenCode engine to be healthy.
        </LayoutSectionDescription>
      </LayoutSectionHeader>

      <LayoutSectionItem>
        <LayoutSectionItemHeader>
          <LayoutSectionItemTitle>Move Rantai-managed config</LayoutSectionItemTitle>
          <LayoutSectionItemDescription>
            Moves older Rantai-owned runtime keys from `.opencode/openwork.json` and safe Rantai-managed keys from `opencode.jsonc` into the runtime database.
          </LayoutSectionItemDescription>
          <LayoutSectionItemHeaderActions>
            <Button
              type="button"
          ...
          <div className="space-y-3 rounded-xl border border-gray-6 bg-gray-1/60 p-3 text-xs text-gray-10">
            ...
            {props.configStatus.sources ? (
              <div className="space-y-3">
                ...
                />
                <RuntimeConfigSourceBlock
                  title="Rantai runtime DB"
                  description="Rantai-managed runtime values stored outside workspace files."
                  keys={props.configStatus.sources.runtimeDatabase.keys}
                  config={props.configStatus.sources.runtimeDatabase.config}
                />
                <RuntimeConfigSourceBlock
                  title="Rantai injected config"
                  description="The object Rantai injects into OpenCode at runtime."
            ...
            <div>
              <div className="font-medium text-gray-12">Legacy Rantai metadata</div>
