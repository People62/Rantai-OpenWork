    ...
    <div className="rounded-xl border border-blue-6/30 bg-blue-3/20 p-3">
      <div className="mb-2 flex items-center justify-between gap-3">
        <div>
          ...
          <div className="text-[11px] text-dls-secondary">Command, working directory, and Rantai-injected environment.</div>
        </div>
      ...
      {props.electronMigrationAvailable ? (
        <div className={cardClass}>
          ...
          <div className="rounded-xl border border-green-7/25 bg-green-3/10 px-3 py-2 text-[12px] leading-relaxed text-green-11">
            ...
            <code className="font-mono">Rantai.app.migrate-bak</code>.
          </div>
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <Button
              ...
              title="Requires a trusted artifact URL. macOS keeps Rantai.app.migrate-bak for rollback."
            >
