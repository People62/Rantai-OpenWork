        ...
        <div className="min-h-0 flex-1 space-y-5 overflow-y-auto">
          {isBusy ? (
            <div className="space-y-4 rounded-xl border border-gray-6/60 bg-gray-1/40 px-5 py-6 text-center">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">{t("mcp.auth.follow_browser_steps")}</p>
                <button
                  type="button"
                  className="text-xs text-muted-foreground underline underline-offset-2 transition-colors hover:text-gray-11"
                  onClick={handleRetry}
                >
          ...
          {!isBusy && alreadyConnected ? (
            <div className="space-y-4 rounded-xl border border-green-7/20 bg-green-7/10 p-5">
              ...
              <p className="text-xs text-muted-foreground">{t("mcp.auth.configured_previously")}</p>
            </div>
          ) : null}
          ...
          {!isBusy && authorizationUrl && props.isRemoteWorkspace && !alreadyConnected ? (
            <div className="space-y-3 rounded-xl border border-gray-6/60 bg-gray-1/40 p-4">
              ...
              <div className="text-xs text-muted-foreground">{t("mcp.auth.manual_finish_hint")}</div>
              ...
              />
              <div className="text-[11px] text-muted-foreground">{t("mcp.auth.port_forward_hint")}</div>
            ...
            <>
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-xs text-muted-foreground">{t("mcp.auth.step2_description")}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-xs text-muted-foreground">{t("mcp.auth.step3_description")}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="rounded-xl border border-gray-6/60 bg-gray-1/40 p-4 text-sm text-gray-11">
                <div className="space-y-3">
                  ...
                  <button
                    type="button"
                    className="text-left text-xs text-muted-foreground underline underline-offset-2 transition-colors hover:text-gray-11"
                    onClick={handleRetry}
                  >
                    {t("mcp.auth.reopen_browser_link")}
                  </button>
